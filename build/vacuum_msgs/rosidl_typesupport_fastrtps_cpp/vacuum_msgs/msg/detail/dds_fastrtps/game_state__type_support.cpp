...
#include "vacuum_msgs/msg/detail/game_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const vacuum_msgs::msg::TrashCount &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  vacuum_msgs::msg::TrashCount &);
...
{
bool cdr_serialize(
  const vacuum_msgs::msg::RobotStatus &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const vacuum_msgs::msg::GameState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vacuum_msgs::msg::GameState & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  // Member: collected
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vacuum_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrashCount(
  ...
  // Member: robots
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vacuum_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RobotStatus(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = vacuum_msgs::msg::GameState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vacuum_msgs::msg::GameState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vacuum_msgs::msg::GameState *>(
    untyped_ros_message);
...
{
  return &vacuum_msgs::msg::typesupport_fastrtps_cpp::_GameState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vacuum_msgs, msg, GameState)() {
  return &vacuum_msgs::msg::typesupport_fastrtps_cpp::_GameState__handle;
}
