...
#include "vacuum_msgs/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vacuum_msgs::msg::RobotStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vacuum_msgs::msg::RobotStatus & ros_message)
{
  // Member: robot_id
  cdr >> ros_message.robot_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vacuum_msgs::msg::RobotStatus;
    is_plain =
      (
      offsetof(DataType, in_collision) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const vacuum_msgs::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vacuum_msgs::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  return &vacuum_msgs::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vacuum_msgs, msg, RobotStatus)() {
  return &vacuum_msgs::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
