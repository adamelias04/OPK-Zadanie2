...
class CollectTrash_Response(metaclass=Metaclass_CollectTrash_Response):
    ...
    _fields_and_field_types = {
        'success': 'boolean',
        'collected': 'vacuum_msgs/TrashItem',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['vacuum_msgs', 'msg'], 'TrashItem'),  # noqa: E501
...
class Metaclass_CollectTrash(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from vacuum_msgs.srv import _collect_trash
...
class CollectTrash(metaclass=Metaclass_CollectTrash):
    from vacuum_msgs.srv._collect_trash import CollectTrash_Request as Request
    from vacuum_msgs.srv._collect_trash import CollectTrash_Response as Response
