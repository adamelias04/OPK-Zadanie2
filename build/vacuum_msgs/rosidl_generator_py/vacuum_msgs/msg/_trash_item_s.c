...
bool vacuum_msgs__msg__trash_item__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vacuum_msgs.msg._trash_item.TrashItem", full_classname_dest, 37) == 0);
  }
  vacuum_msgs__msg__TrashItem * ros_message = _ros_message;
  {  // id
...
PyObject * vacuum_msgs__msg__trash_item__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vacuum_msgs.msg._trash_item");
