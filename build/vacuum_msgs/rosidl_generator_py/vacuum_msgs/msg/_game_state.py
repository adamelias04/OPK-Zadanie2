...
class GameState(metaclass=Metaclass_GameState):
    ...
    _fields_and_field_types = {
        ...
        'score': 'int32',
        'collected': 'sequence<vacuum_msgs/TrashCount>',
        'active_trash': 'sequence<vacuum_msgs/TrashItem>',
        'robots': 'sequence<vacuum_msgs/RobotStatus>',
        'winner': 'string',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['vacuum_msgs', 'msg'], 'TrashCount')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['vacuum_msgs', 'msg'], 'TrashItem')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['vacuum_msgs', 'msg'], 'RobotStatus')),  # noqa: E501
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
    )
