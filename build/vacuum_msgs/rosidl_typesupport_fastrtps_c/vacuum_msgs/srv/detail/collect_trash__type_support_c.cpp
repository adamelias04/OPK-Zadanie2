...
#include "vacuum_msgs/srv/detail/collect_trash__rosidl_typesupport_fastrtps_c.h"
...
using _CollectTrash_Request__ros_msg_type = vacuum_msgs__srv__CollectTrash_Request;
...
size_t get_serialized_size_vacuum_msgs__srv__CollectTrash_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CollectTrash_Request__ros_msg_type * ros_message = static_cast<const _CollectTrash_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _CollectTrash_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vacuum_msgs__srv__CollectTrash_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vacuum_msgs
size_t max_serialized_size_vacuum_msgs__srv__CollectTrash_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vacuum_msgs__srv__CollectTrash_Request;
    is_plain =
      (
...
static size_t _CollectTrash_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vacuum_msgs__srv__CollectTrash_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vacuum_msgs, srv, CollectTrash_Request)() {
...
#include "vacuum_msgs/msg/detail/trash_item__functions.h"  // collected
...
using _CollectTrash_Response__ros_msg_type = vacuum_msgs__srv__CollectTrash_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vacuum_msgs
size_t get_serialized_size_vacuum_msgs__srv__CollectTrash_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CollectTrash_Response__ros_msg_type * ros_message = static_cast<const _CollectTrash_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_vacuum_msgs__srv__CollectTrash_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vacuum_msgs
size_t max_serialized_size_vacuum_msgs__srv__CollectTrash_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vacuum_msgs__srv__CollectTrash_Response;
    is_plain =
      (
...
static size_t _CollectTrash_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vacuum_msgs__srv__CollectTrash_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vacuum_msgs, srv, CollectTrash_Response)() {
...
// already included above
// #include "vacuum_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "vacuum_msgs/srv/collect_trash.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vacuum_msgs, srv, CollectTrash)() {
