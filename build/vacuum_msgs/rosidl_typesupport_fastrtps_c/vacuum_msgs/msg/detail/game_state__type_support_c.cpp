...
#include "vacuum_msgs/msg/detail/game_state__rosidl_typesupport_fastrtps_c.h"
...
#include "vacuum_msgs/msg/detail/robot_status__functions.h"  // robots
#include "vacuum_msgs/msg/detail/trash_count__functions.h"  // collected
#include "vacuum_msgs/msg/detail/trash_item__functions.h"  // active_trash

// forward declare type support functions
size_t get_serialized_size_vacuum_msgs__msg__RobotStatus(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_vacuum_msgs__msg__RobotStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vacuum_msgs, msg, RobotStatus)();
size_t get_serialized_size_vacuum_msgs__msg__TrashCount(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_vacuum_msgs__msg__TrashCount(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vacuum_msgs, msg, TrashCount)();
size_t get_serialized_size_vacuum_msgs__msg__TrashItem(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_vacuum_msgs__msg__TrashItem(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vacuum_msgs, msg, TrashItem)();


using _GameState__ros_msg_type = vacuum_msgs__msg__GameState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: collected
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, vacuum_msgs, msg, TrashCount
      )()->data);
  ...
  // Field name: active_trash
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, vacuum_msgs, msg, TrashItem
      )()->data);
  ...
  // Field name: robots
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, vacuum_msgs, msg, RobotStatus
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: collected
  {
    ...
    if (ros_message->collected.data) {
      vacuum_msgs__msg__TrashCount__Sequence__fini(&ros_message->collected);
    }
  ...
  // Field name: active_trash
  {
    ...
    if (ros_message->active_trash.data) {
      vacuum_msgs__msg__TrashItem__Sequence__fini(&ros_message->active_trash);
    }
  ...
  // Field name: robots
  {
    ...
    if (ros_message->robots.data) {
      vacuum_msgs__msg__RobotStatus__Sequence__fini(&ros_message->robots);
    }
...
size_t get_serialized_size_vacuum_msgs__msg__GameState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GameState__ros_msg_type * ros_message = static_cast<const _GameState__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name collected
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_vacuum_msgs__msg__TrashCount(
  ...
  // field.name active_trash
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_vacuum_msgs__msg__TrashItem(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name robots
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_vacuum_msgs__msg__RobotStatus(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name winner
...
static uint32_t _GameState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vacuum_msgs__msg__GameState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vacuum_msgs
size_t max_serialized_size_vacuum_msgs__msg__GameState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: collected
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_vacuum_msgs__msg__TrashCount(
  ...
  // member: active_trash
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_vacuum_msgs__msg__TrashItem(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: robots
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_vacuum_msgs__msg__RobotStatus(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = vacuum_msgs__msg__GameState;
    is_plain =
      (
...
static size_t _GameState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vacuum_msgs__msg__GameState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vacuum_msgs, msg, GameState)() {
