...
vacuum_msgs__srv__UnloadTrash_Request__init(vacuum_msgs__srv__UnloadTrash_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->robot_id)) {
    vacuum_msgs__srv__UnloadTrash_Request__fini(msg);
    return false;
  }
  // robot_pos
...
vacuum_msgs__srv__UnloadTrash_Request__create()
{
  ...
  vacuum_msgs__srv__UnloadTrash_Request * msg = (vacuum_msgs__srv__UnloadTrash_Request *)allocator.allocate(sizeof(vacuum_msgs__srv__UnloadTrash_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(vacuum_msgs__srv__UnloadTrash_Request));
  bool success = vacuum_msgs__srv__UnloadTrash_Request__init(msg);
  if (!success) {
...
vacuum_msgs__srv__UnloadTrash_Request__Sequence__init(vacuum_msgs__srv__UnloadTrash_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vacuum_msgs__srv__UnloadTrash_Request * data = NULL;

  if (size) {
    data = (vacuum_msgs__srv__UnloadTrash_Request *)allocator.zero_allocate(size, sizeof(vacuum_msgs__srv__UnloadTrash_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = vacuum_msgs__srv__UnloadTrash_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        vacuum_msgs__srv__UnloadTrash_Request__fini(&data[i - 1]);
      }
...
vacuum_msgs__srv__UnloadTrash_Request__Sequence__fini(vacuum_msgs__srv__UnloadTrash_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      vacuum_msgs__srv__UnloadTrash_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vacuum_msgs__srv__UnloadTrash_Request__Sequence * array = (vacuum_msgs__srv__UnloadTrash_Request__Sequence *)allocator.allocate(sizeof(vacuum_msgs__srv__UnloadTrash_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = vacuum_msgs__srv__UnloadTrash_Request__Sequence__init(array, size);
  if (!success) {
...
vacuum_msgs__srv__UnloadTrash_Request__Sequence__destroy(vacuum_msgs__srv__UnloadTrash_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    vacuum_msgs__srv__UnloadTrash_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
vacuum_msgs__srv__UnloadTrash_Request__Sequence__are_equal(const vacuum_msgs__srv__UnloadTrash_Request__Sequence * lhs, const vacuum_msgs__srv__UnloadTrash_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!vacuum_msgs__srv__UnloadTrash_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  vacuum_msgs__srv__UnloadTrash_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(vacuum_msgs__srv__UnloadTrash_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    vacuum_msgs__srv__UnloadTrash_Request * data =
      (vacuum_msgs__srv__UnloadTrash_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vacuum_msgs__srv__UnloadTrash_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vacuum_msgs__srv__UnloadTrash_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!vacuum_msgs__srv__UnloadTrash_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vacuum_msgs__srv__UnloadTrash_Response * msg = (vacuum_msgs__srv__UnloadTrash_Response *)allocator.allocate(sizeof(vacuum_msgs__srv__UnloadTrash_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(vacuum_msgs__srv__UnloadTrash_Response));
  bool success = vacuum_msgs__srv__UnloadTrash_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
vacuum_msgs__srv__UnloadTrash_Response__destroy(vacuum_msgs__srv__UnloadTrash_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    vacuum_msgs__srv__UnloadTrash_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
vacuum_msgs__srv__UnloadTrash_Response__Sequence__init(vacuum_msgs__srv__UnloadTrash_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vacuum_msgs__srv__UnloadTrash_Response * data = NULL;

  if (size) {
    data = (vacuum_msgs__srv__UnloadTrash_Response *)allocator.zero_allocate(size, sizeof(vacuum_msgs__srv__UnloadTrash_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = vacuum_msgs__srv__UnloadTrash_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        vacuum_msgs__srv__UnloadTrash_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
vacuum_msgs__srv__UnloadTrash_Response__Sequence__fini(vacuum_msgs__srv__UnloadTrash_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      vacuum_msgs__srv__UnloadTrash_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vacuum_msgs__srv__UnloadTrash_Response__Sequence * array = (vacuum_msgs__srv__UnloadTrash_Response__Sequence *)allocator.allocate(sizeof(vacuum_msgs__srv__UnloadTrash_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = vacuum_msgs__srv__UnloadTrash_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
vacuum_msgs__srv__UnloadTrash_Response__Sequence__destroy(vacuum_msgs__srv__UnloadTrash_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    vacuum_msgs__srv__UnloadTrash_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
vacuum_msgs__srv__UnloadTrash_Response__Sequence__are_equal(const vacuum_msgs__srv__UnloadTrash_Response__Sequence * lhs, const vacuum_msgs__srv__UnloadTrash_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!vacuum_msgs__srv__UnloadTrash_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  vacuum_msgs__srv__UnloadTrash_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(vacuum_msgs__srv__UnloadTrash_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    vacuum_msgs__srv__UnloadTrash_Response * data =
      (vacuum_msgs__srv__UnloadTrash_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vacuum_msgs__srv__UnloadTrash_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vacuum_msgs__srv__UnloadTrash_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!vacuum_msgs__srv__UnloadTrash_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
