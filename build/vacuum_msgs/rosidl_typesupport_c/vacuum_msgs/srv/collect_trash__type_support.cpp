...
static const _CollectTrash_Request_type_support_symbol_names_t _CollectTrash_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vacuum_msgs, srv, CollectTrash_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vacuum_msgs, srv, CollectTrash_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vacuum_msgs, srv, CollectTrash_Request)() {
  return &::vacuum_msgs::srv::rosidl_typesupport_c::CollectTrash_Request_message_type_support_handle;
}
...
static const _CollectTrash_Response_type_support_symbol_names_t _CollectTrash_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vacuum_msgs, srv, CollectTrash_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vacuum_msgs, srv, CollectTrash_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vacuum_msgs, srv, CollectTrash_Response)() {
  return &::vacuum_msgs::srv::rosidl_typesupport_c::CollectTrash_Response_message_type_support_handle;
}
...
static const _CollectTrash_type_support_symbol_names_t _CollectTrash_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vacuum_msgs, srv, CollectTrash)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vacuum_msgs, srv, CollectTrash)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, vacuum_msgs, srv, CollectTrash)() {
  return &::vacuum_msgs::srv::rosidl_typesupport_c::CollectTrash_service_type_support_handle;
}
