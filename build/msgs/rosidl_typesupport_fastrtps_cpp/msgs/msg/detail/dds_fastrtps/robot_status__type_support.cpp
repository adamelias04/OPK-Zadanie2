...
#include "msgs/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const msgs::msg::RobotStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msgs::msg::RobotStatus & ros_message)
{
  // Member: robot_id
  cdr >> ros_message.robot_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs::msg::RobotStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msgs::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msgs::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  return &msgs::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msgs, msg, RobotStatus)() {
  return &msgs::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
