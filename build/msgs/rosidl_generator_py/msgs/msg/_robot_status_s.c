...
bool msgs__msg__robot_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msgs.msg._robot_status.RobotStatus", full_classname_dest, 34) == 0);
  }
  msgs__msg__RobotStatus * ros_message = _ros_message;
  {  // robot_id
...
PyObject * msgs__msg__robot_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msgs.msg._robot_status");
