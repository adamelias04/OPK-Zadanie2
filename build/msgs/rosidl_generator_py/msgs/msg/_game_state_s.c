...
bool msgs__msg__trash_count__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool msgs__msg__robot_status__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * msgs__msg__robot_status__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool msgs__msg__game_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msgs.msg._game_state.GameState", full_classname_dest, 30) == 0);
  }
  msgs__msg__GameState * ros_message = _ros_message;
  {  // mode
  ...
  {  // collected
    ...
    if (!msgs__msg__TrashCount__Sequence__init(&(ros_message->collected), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create msgs__msg__TrashCount__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    msgs__msg__TrashCount * dest = ros_message->collected.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!msgs__msg__trash_count__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // active_trash
    ...
    if (!msgs__msg__TrashItem__Sequence__init(&(ros_message->active_trash), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create msgs__msg__TrashItem__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    msgs__msg__TrashItem * dest = ros_message->active_trash.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!msgs__msg__trash_item__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // robots
    ...
    if (!msgs__msg__RobotStatus__Sequence__init(&(ros_message->robots), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create msgs__msg__RobotStatus__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    msgs__msg__RobotStatus * dest = ros_message->robots.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!msgs__msg__robot_status__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * msgs__msg__game_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msgs.msg._game_state");
  ...
  {  // collected
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = msgs__msg__trash_count__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // active_trash
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = msgs__msg__trash_item__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // robots
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = msgs__msg__robot_status__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
