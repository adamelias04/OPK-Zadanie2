...
bool msgs__msg__trash_item__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msgs.msg._trash_item.TrashItem", full_classname_dest, 30) == 0);
  }
  msgs__msg__TrashItem * ros_message = _ros_message;
  {  // id
  ...
  {  // score_value
    PyObject * field = PyObject_GetAttrString(_pymsg, "score_value");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->score_value = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of TrashItem */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("msgs.msg._trash_item");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrashItem");
  ...
  {  // score_value
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->score_value);
    {
      int rc = PyObject_SetAttrString(_pymessage, "score_value", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
