...
#include "msgs/msg/detail/trash_item__rosidl_typesupport_fastrtps_c.h"
...
using _TrashItem__ros_msg_type = msgs__msg__TrashItem;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrashItem__ros_msg_type * ros_message = static_cast<const _TrashItem__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _TrashItem__ros_msg_type * ros_message = static_cast<_TrashItem__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
...
static uint32_t _TrashItem__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msgs__msg__TrashItem(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs__msg__TrashItem;
    is_plain =
      (
...
static size_t _TrashItem__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msgs__msg__TrashItem(
...
static message_type_support_callbacks_t __callbacks_TrashItem = {
  "msgs::msg",
  "TrashItem",
...
static rosidl_message_type_support_t _TrashItem__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrashItem,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msgs, msg, TrashItem)() {
  return &_TrashItem__type_support;
}
