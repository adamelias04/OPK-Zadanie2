...
static const _UnloadTrash_Request_type_support_symbol_names_t _UnloadTrash_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msgs, srv, UnloadTrash_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msgs, srv, UnloadTrash_Request)),
  }
};
...
{
  return &::msgs::srv::rosidl_typesupport_cpp::UnloadTrash_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, msgs, srv, UnloadTrash_Request)() {
  return get_message_type_support_handle<msgs::srv::UnloadTrash_Request>();
}
...
static const _UnloadTrash_Response_type_support_symbol_names_t _UnloadTrash_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msgs, srv, UnloadTrash_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msgs, srv, UnloadTrash_Response)),
  }
};
...
{
  return &::msgs::srv::rosidl_typesupport_cpp::UnloadTrash_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, msgs, srv, UnloadTrash_Response)() {
  return get_message_type_support_handle<msgs::srv::UnloadTrash_Response>();
}
...
static const _UnloadTrash_type_support_symbol_names_t _UnloadTrash_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msgs, srv, UnloadTrash)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msgs, srv, UnloadTrash)),
  }
};
...
{
  return &::msgs::srv::rosidl_typesupport_cpp::UnloadTrash_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, msgs, srv, UnloadTrash)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<msgs::srv::UnloadTrash>();
}
