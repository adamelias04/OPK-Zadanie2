...
{
  new (message_memory) msgs::msg::GameState(_init);
}

void GameState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msgs::msg::GameState *>(message_memory);
  typed_message->~GameState();
}

size_t size_function__GameState__collected(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<msgs::msg::TrashCount> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<msgs::msg::TrashCount> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<msgs::msg::TrashCount> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const msgs::msg::TrashCount *>(
    get_const_function__GameState__collected(untyped_member, index));
  auto & value = *reinterpret_cast<msgs::msg::TrashCount *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<msgs::msg::TrashCount *>(
    get_function__GameState__collected(untyped_member, index));
  const auto & value = *reinterpret_cast<const msgs::msg::TrashCount *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<msgs::msg::TrashItem> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<msgs::msg::TrashItem> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<msgs::msg::TrashItem> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__GameState__active_trash(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const msgs::msg::TrashItem *>(
    get_const_function__GameState__active_trash(untyped_member, index));
  auto & value = *reinterpret_cast<msgs::msg::TrashItem *>(untyped_value);
  value = item;
}
...
void assign_function__GameState__active_trash(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<msgs::msg::TrashItem *>(
    get_function__GameState__active_trash(untyped_member, index));
  const auto & value = *reinterpret_cast<const msgs::msg::TrashItem *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<msgs::msg::RobotStatus> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<msgs::msg::RobotStatus> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<msgs::msg::RobotStatus> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__GameState__robots(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const msgs::msg::RobotStatus *>(
    get_const_function__GameState__robots(untyped_member, index));
  auto & value = *reinterpret_cast<msgs::msg::RobotStatus *>(untyped_value);
  value = item;
}
...
void assign_function__GameState__robots(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<msgs::msg::RobotStatus *>(
    get_function__GameState__robots(untyped_member, index));
  const auto & value = *reinterpret_cast<const msgs::msg::RobotStatus *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GameState_message_member_array[8] = {
  {
    ...
    offsetof(msgs::msg::GameState, mode),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msgs::msg::GameState, phase),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msgs::msg::GameState, elapsed_seconds),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msgs::msg::GameState, score),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<msgs::msg::TrashCount>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(msgs::msg::GameState, collected),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<msgs::msg::TrashItem>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(msgs::msg::GameState, active_trash),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<msgs::msg::RobotStatus>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(msgs::msg::GameState, robots),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msgs::msg::GameState, winner),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::msgs::msg::rosidl_typesupport_introspection_cpp::GameState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msgs, msg, GameState)() {
  return &::msgs::msg::rosidl_typesupport_introspection_cpp::GameState_message_type_support_handle;
}
