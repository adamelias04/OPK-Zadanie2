...
#ifndef MSGS__MSG__DETAIL__ROBOT_STATUS__STRUCT_HPP_
#define MSGS__MSG__DETAIL__ROBOT_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__msgs__msg__RobotStatus __attribute__((deprecated))
#else
# define DEPRECATED__msgs__msg__RobotStatus __declspec(deprecated)
#endif
...
struct RobotStatus_
{
  ...
  // pointer types
  using RawPtr =
    msgs::msg::RobotStatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const msgs::msg::RobotStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<msgs::msg::RobotStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<msgs::msg::RobotStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      msgs::msg::RobotStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<msgs::msg::RobotStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<msgs::msg::RobotStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<msgs::msg::RobotStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<msgs::msg::RobotStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__msgs__msg__RobotStatus
    std::shared_ptr<msgs::msg::RobotStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__msgs__msg__RobotStatus
    std::shared_ptr<msgs::msg::RobotStatus_<ContainerAllocator> const>
...
using RobotStatus =
  msgs::msg::RobotStatus_<std::allocator<void>>;
...
#endif  // MSGS__MSG__DETAIL__ROBOT_STATUS__STRUCT_HPP_
