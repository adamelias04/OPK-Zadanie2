...
#ifndef MSGS__SRV__DETAIL__RESET_GAME__FUNCTIONS_H_
#define MSGS__SRV__DETAIL__RESET_GAME__FUNCTIONS_H_
 ...
 * calls
 * msgs__srv__ResetGame_Request__init().
...
/**
 * It calls
 * msgs__srv__ResetGame_Request__fini()
 ...
 * msgs__srv__ResetGame_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * msgs__srv__ResetGame_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * msgs__srv__ResetGame_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_msgs
...
/**
 * It calls
 * msgs__srv__ResetGame_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_msgs
...
/**
 * It allocates the memory for the array and calls
 * msgs__srv__ResetGame_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_msgs
...
/**
 * It calls
 * msgs__srv__ResetGame_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MSGS__SRV__DETAIL__RESET_GAME__FUNCTIONS_H_
