...
class Metaclass_UnloadTrash(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from msgs.srv import _unload_trash
...
class UnloadTrash(metaclass=Metaclass_UnloadTrash):
    from msgs.srv._unload_trash import UnloadTrash_Request as Request
    from msgs.srv._unload_trash import UnloadTrash_Response as Response
