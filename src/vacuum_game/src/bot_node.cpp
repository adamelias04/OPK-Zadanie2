...
public:
    BotNode() : rclcpp::Node("bot_node") {
        ...
        game_sub_ = create_subscription<vacuum_msgs::msg::GameState>(
            "/game_state", 10,
...
private:
    void tick() {
        ...
        std::optional<vacuum_core::geometry::Point2d> station{{station_x_, station_y_}};
        auto target = vacuum_core::game::BotController::pickTarget(
            state_, trash_positions_, station, capacity_used_, capacity_max_);
        auto cmd = vacuum_core::game::BotController::computeCommand(
    ...
    vacuum_core::geometry::RobotState state_{};
    std::vector<vacuum_core::geometry::Point2d> trash_positions_;
    std::string game_phase_{"RUNNING"};

    rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr cmd_pub_;
    rclcpp::Subscription<vacuum_msgs::msg::RobotStatus>::SharedPtr status_sub_;
    rclcpp::Subscription<vacuum_msgs::msg::GameState>::SharedPtr game_sub_;
