...
def generate_launch_description():
    pkg_share = get_package_share_directory('vacuum_bringup')
    ...
    # NOTE: launch two teleop nodes in separate terminals so each captures keyboard input:
    #   Terminal 1 (Player):  ros2 run vacuum_game teleop_node --ros-args -p robot_id:=player
    #   Terminal 2 (Player2): ros2 run vacuum_game teleop_node --ros-args -p robot_id:=bot
